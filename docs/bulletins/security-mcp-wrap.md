...
**Date:** 2026-07-16  
**Post-merge note:** Code ships on `main`; promoted to **STABLE** following comprehensive validation and integration testing.
...
- [x] Semver / CHANGELOG updated for `0.2.0` release.
