...
**Date:** 2026-07-16  
**Post-merge note:** Code ships on `main`; **Status promoted to STABLE** following completion of real child MCP integration tests, consumer acknowledgments, and review sign-off.
