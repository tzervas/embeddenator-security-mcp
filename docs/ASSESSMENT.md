...
| Proxy / wrap-other-tools | **5** | **STABLE** — promoted following successful real-child integration tests and fleet consumer approvals. |
...
**Closed (was Med):** “Proxy wrap incomplete STABLE” — fully promoted to STABLE with real child process integration tests (`tests/proxy_integration.rs`) and all fleet consumer acknowledgments complete.
